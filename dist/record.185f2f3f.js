...
},{"regenerator-runtime/runtime.js":"../node_modules/regenerator-runtime/runtime.js"}],"record.js":[function(require,module,exports) {
"use strict";
...
var ID = localStorage.getItem("ID"); // 0支出 1收入
...
$(document).ready(function () {
  ...
  $('#accounting #everyday_earn #add_deals_btn, #main #mainpage #add_deal_btn').click(function (event) {
...
$('#login_btn, #save, .datebox,#signup_btn').click(function (event) {
  event.preventDefault();
  var count = 0;
...
function _showtoday() {
  _showtoday = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return mod.getTodayMoney(ID, 'account', YEAR, MONTH, DAY, 'cost', 0);

          case 6:
            dayExpenditure = _context.sent;
            _context.next = 9;
            return mod.getTodayMoney(ID, 'account', YEAR, MONTH, DAY, 'cost', 1);
