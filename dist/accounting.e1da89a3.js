...
},{"regenerator-runtime/runtime.js":"../node_modules/regenerator-runtime/runtime.js"}],"accounting.js":[function(require,module,exports) {
"use strict";
...
$('#accounting #everyday_earn #add_deals_btn').click(function () {
  ...
  setTimeout(function () {
    ...
    $('#fin input[name=date]').val("".concat(mod.datetransfer(today.getMonth() + 1), "/").concat(mod.datetransfer(today.getDate()), "/").concat(today.getFullYear()));
  }, 100);
});
...
>>>>>>> 19fcf4cca50d4d8beedf81b1d213a5ccb8cd8fa7
