...
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"test.js":[function(require,module,exports) {
"use strict";
...
$('#login button[type="submit"]').click(function (event) {
  event.preventDefault();
  setTimeout(function () {
    $('#login-output').html(_signup.default);
  }, 500);
});
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33666" + '/');
