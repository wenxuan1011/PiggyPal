...
},{"regenerator-runtime/runtime.js":"../node_modules/regenerator-runtime/runtime.js"}],"mainpage.js":[function(require,module,exports) {
"use strict";
...
$('#login_btn, #save, #signup_btn').click(function (event) {
  event.preventDefault();
  setTimeout(function () {
    getdetail();
  }, 100);
});
$('#add_deals_circle').click(function (event) {
  event.preventDefault();
  ...
  $.get('./getmainpagedetail', {
    ...
    if (data != "nothing") {
      ...
      for (var i in data) {
        ...
        types.setAttribute('src', "./image/Accounting/".concat(detailpicture(sort, type), "_icon.png"));
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","mainpage.js"], null)
