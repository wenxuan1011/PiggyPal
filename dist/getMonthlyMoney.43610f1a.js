...
},{}],"getMonthlyMoney.js":[function(require,module,exports) {
"use strict";
...
function getMonthlyMoney(ID, table, selection, month, type) {
  ...
  $.get('./monthlymoney', {
    ...
    if (_typeof(data) != String) {
      ...
      for (var i in data) {
        console.log(mod.StringtoInt(mod.gettabledata(data, "".concat(selection), i))); //console.log(1)
        //console.log(i,data)

        total += mod.StringtoInt(mod.gettabledata(data, "".concat(selection), i));
        i++;
      } //total=gettabledata(money,type,0)
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","getMonthlyMoney.js"], null)
//# sourceMappingURL=getMonthlyMoney.43610f1a.js.map